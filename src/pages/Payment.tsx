...
export default function Payment() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-canvas p-4">
      <div className="w-full max-w-md overflow-hidden rounded-panel border border-border bg-paper shadow-sm">
        <div className="bg-gradient-to-r from-emerald-50 via-white to-orange-50 p-8 text-center">
          ...
          <h2 className="mb-2 text-2xl font-bold text-ink-1">扫码支付稍后开发</h2>
          <p className="text-sm text-ink-3">本轮请使用卡密/激活码完成账号开通。</p>
        </div>

        <div className="space-y-6 p-8">
          <div className="rounded-panel border border-warning/20 bg-warning/10 p-5 text-sm leading-6 text-warning">
