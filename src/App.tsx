      ...
      <Router>
        <ThemeWrapper>
          <Routes>
            ...
            <Route path="/teacher" element={<PrivateRoute allowedRoles={['teacher', 'superadmin']}><TeacherLayout /></PrivateRoute>}>
          ...
          <Route path="guild-pk" element={<StudentGuildPK />} />
            ...
            <Route path="/parent" element={<PrivateRoute allowedRoles={['parent']}><ParentLayout /></PrivateRoute>}>
            ...
            <Route path={ADMIN_PATH} element={<PrivateRoute allowedRoles={['admin', 'superadmin']}><AdminLayout /></PrivateRoute>}>
