      ...
      <footer className="border-t border-border bg-paper">
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-10 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-sm text-ink-3">
            <Link to="/about" className="hover:text-ink-2 transition-colors">关于</Link>
            <Link to="/contact" className="hover:text-ink-2 transition-colors">联系</Link>
            <Link to="/news" className="hover:text-ink-2 transition-colors">动态</Link>
          </div>
        </div>
      </footer>
    </div>
