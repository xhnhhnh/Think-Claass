    ...
    <MenuPrimitive.Portal>
      ...
      >
        <MenuPrimitive.Popup
          ...
          className={cn("z-50 max-h-[var(--available-height)] w-[var(--anchor-width)] min-w-32 origin-[var(--transform-origin)] overflow-x-hidden overflow-y-auto rounded-lg bg-popover p-1 text-popover-foreground shadow-md ring-1 ring-foreground/10 duration-100 outline-none data-[side=bottom]:animate-slide-in-top data-[side=inline-end]:animate-slide-in-right data-[side=inline-start]:animate-slide-in-left data-[side=left]:animate-slide-in-left data-[side=right]:animate-slide-in-right data-[side=top]:animate-slide-in-bottom data-[open]:animate-fade-in data-[closed]:animate-fade-out data-[closed]:overflow-hidden", className )}
          {...props}
        />
      </MenuPrimitive.Positioner>
    </MenuPrimitive.Portal>
