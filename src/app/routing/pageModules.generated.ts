...
export const pageModules: Record<string, () => Promise<unknown>> = {
  '@/app/layouts/AdminLayout': () => import('@/app/layouts/AdminLayout'),
  '@/app/layouts/ParentLayout': () => import('@/app/layouts/ParentLayout'),
  '@/app/layouts/StudentLayout': () => import('@/app/layouts/StudentLayout'),
  '@/app/layouts/TeacherLayout': () => import('@/app/layouts/TeacherLayout'),
  ...
  '@/features/admin/pages/AdminDashboardPage': () => import('@/features/admin/pages/AdminDashboardPage'),
  '@/features/admin/pages/AdminLoginPage': () => import('@/features/admin/pages/AdminLoginPage'),
  '@/features/admin/pages/AdminOpenApiPage': () => import('@/features/admin/pages/AdminOpenApiPage'),
  '@/features/admin/pages/AdminSettingsPage': () => import('@/features/admin/pages/AdminSettingsPage'),
  '@/features/admin/pages/AdminSystemResetPage': () => import('@/features/admin/pages/AdminSystemResetPage'),
  ...
  '@/features/ai-study/pages/StudentAiStudyAttemptPage': () => import('@/features/ai-study/pages/StudentAiStudyAttemptPage'),
  '@/features/ai-study/pages/StudentAiStudyPage': () => import('@/features/ai-study/pages/StudentAiStudyPage'),
  '@/features/ai-study/pages/TeacherAiStudyPage': () => import('@/features/ai-study/pages/TeacherAiStudyPage'),
  ...
  '@/features/auth/pages/ProfileSettingsPage': () => import('@/features/auth/pages/ProfileSettingsPage'),
  ...
  '@/features/classroom/pages/StudentOverviewPage': () => import('@/features/classroom/pages/StudentOverviewPage'),
  ...
  '@/features/homework/pages/StudentHomeworkAttemptPage': () => import('@/features/homework/pages/StudentHomeworkAttemptPage'),
  '@/features/homework/pages/StudentHomeworkPage': () => import('@/features/homework/pages/StudentHomeworkPage'),
  '@/features/homework/pages/StudentHomeworkResultPage': () => import('@/features/homework/pages/StudentHomeworkResultPage'),
  '@/features/homework/pages/TeacherHomeworkGradePage': () => import('@/features/homework/pages/TeacherHomeworkGradePage'),
  '@/features/homework/pages/TeacherHomeworkPage': () => import('@/features/homework/pages/TeacherHomeworkPage'),
