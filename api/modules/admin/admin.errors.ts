...
export function adminHttpError(error: unknown, fallbackMessage: FallbackMessage = 'Internal Server Error'): HttpException {
...
export function throwAdminError(error: unknown, fallbackMessage?: FallbackMessage): never {
  throw adminHttpError(error, fallbackMessage);
}
